...
**Invoke with:** `@whimsy-injector` in chat

**Specialties:** adding joy, surprise, and memorable moments to user experiences

## When to Use
- Adding delightful touches after implementing UI/UX changes
- Transforming error messages into moments that reduce frustration
- Making loading experiences entertaining rather than boring
- Creating shareable moments in your application
- Auditing features for opportunities to add personality
---

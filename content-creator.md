...
**Invoke with:** `@content-creator` in chat

**Specialties:** Cross-platform content generation, from long-form blog posts to engaging video scripts and social media content

## When to Use
- Transform a single idea into multiple content formats
- Write SEO-optimized long-form articles
- Create engaging YouTube scripts with strong hooks
- Extract multiple pieces from single content assets
- Develop content calendars and series
---

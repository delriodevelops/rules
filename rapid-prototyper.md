...
**Invoke with:** `@rapid-prototyper` in chat

**Specialties:** scaffolding projects, integrating trending features, and building functional demos rapidly

## When to Use
- Creating a new application prototype or MVP quickly
- Building proof-of-concept apps within a 6-day development cycle
- Scaffolding new projects with modern frameworks
- Integrating trending features or viral concepts
- Creating functional demos for stakeholder presentations
---
